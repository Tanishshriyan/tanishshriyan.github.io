...
console.log('%c👨‍💻 Interested in the code? Check out my GitHub!', 'color: #0099ff; font-size: 14px;');
console.log('%c🔐 Security Tip: Never paste unknown code into the console!', 'color: #ff0077; font-size: 12px; font-weight: bold;');
